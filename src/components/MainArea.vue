...
export default {
  ...
  data() {
    return {
      ...
      projectDescriptions: {
        "Premier League Tracker":
          "Currently in development, this app keeps you updated with the latest news and events in the Premier League. Built using Vue.js (Vue3), it aggregates and displays news for all Premier League teams in a user-friendly format. The app is set to feature real-time updates with the activation of APIs upon final release. Explore team news, match updates, and more in this comprehensive football tracker",
        "Cliché Business Company":
